...
Voici un schéma décrivant l'état de la liste chaînée dans le tableau \ocamlf{arr}
à un moment donné pendant une exécution du crible d'Euler.
Dans celle-ci l'algorithme vient de marquer (en gris) tous les multiples de $2$.
Il va commencer à marquer (en bleu) les multiples de 3, ici les produits de $3$
avec $3$, $5$, $7$, $9$, ...
