...
La deuxième partie de la preuve a consisté en le raffinement de type \whyf{t}
précédemment défini. Ce raffinement se trouve dans le module
\whyf{EulerSieveImpl} qui est une implémentation~\cite{paskevich20isola}
du module \whyf{EulerSieve}.
...
défini ci-dessus.
% pas très bien dit ...
Enfin, le module d'implémentation et le module abstrait ont été liés par
l'instruction \whyf{clone} de Why3 :
\begin{why3}
...
Au total, 841 buts on été prouvés.
% spec     code comments
...
est-il efficace ? comparaison avec le crible d'Ératosthène et le crible
d'Ératosthène segmenté.
