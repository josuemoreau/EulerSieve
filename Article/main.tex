...
\begin{tikzpicture}[>=latex]
  ...
  column 7/.style={nodes={fill=gray!30}},
  column 9/.style={nodes={fill=gray!30}},
  column 11/.style={nodes={fill=gray!30}},
  column 13/.style={nodes={fill=gray!30}},
  column 15/.style={nodes={fill=gray!30}},
  column 17/.style={nodes={fill=gray!30}},
  % marquage suivant
  column 8/.style={nodes={fill=blue!30}},
  column 14/.style={nodes={fill=blue!30}},
  ]
at (0,0)
(mat1)
{
...
\draw[->, dashed, line width=0.7pt]
(mat1-1-2.north)
.. controls ++ (0.1,0.6) and ++(-0.1,0.6) ..
(mat1-1-6.north);
\draw[->, dashed, line width=0.7pt]
(mat1-1-2.north)
  .. controls ++ (0.1,0.9) and ++(-0.1,0.9) ..
(mat1-1-8.north);
\end{scope}
\end{tikzpicture}
